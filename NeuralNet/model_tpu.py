...
def parallel(charged_pf_timestep, n_charged_pf_features, photon_pf_timestep, n_photon_pf_features, neutralHad_pf_timestep, n_neutralHad_pf_features, n_global_features, scale):
  ...
  lstm_charged_pf = tf.keras.layers.LSTM(int(scale*150.), implementation = 2, name ='lstm_charged_pf_1', go_backwards = go_backwards)(conv_charged_pf)
  lstm_charged_pf = tf.keras.layers.Dropout(dropout_rate_1, name = 'lstm_charged_pf_dropout')(lstm_charged_pf)

  lstm_photon_pf = tf.keras.layers.LSTM(int(scale*100.), implementation = 2, name = 'lstm_photon_pf_1', go_backwards = go_backwards)(conv_photon_pf)
  lstm_photon_pf = tf.keras.layers.Dropout(dropout_rate_1, name = 'lstm_photon_pf_dropout')(lstm_photon_pf)

  lstm_neutralHad_pf = tf.keras.layers.LSTM(int(scale*50.), implementation = 2, name = 'lstm_neutralHad_pf_1', go_backwards = go_backwards)(conv_neutralHad_pf)
  ...
  deep_layer = tf.keras.layers.Dense(int(scale*200.), activation = 'relu', kernel_initializer = 'lecun_uniform',  name = 'mlp_1')(cand_features)
  deep_layer = tf.keras.layers.Dropout(dropout_rate_2, name = 'mlp_dropout_1')(deep_layer)
  deep_layer = tf.keras.layers.Dense(int(scale*100.), activation = 'relu', kernel_initializer = 'lecun_uniform',  name = 'mlp_2')(deep_layer)
  deep_layer = tf.keras.layers.Dropout(dropout_rate_2, name = 'mlp_dropout_2')(deep_layer)
  deep_layer = tf.keras.layers.Dense(int(scale*100.), activation = 'relu', kernel_initializer = 'lecun_uniform',  name = 'mlp_3')(deep_layer)
  deep_layer = tf.keras.layers.Dropout(dropout_rate_2, name = 'mlp_dropout_3')(deep_layer)
  deep_layer = tf.keras.layers.Dense(int(scale*100.), activation = 'relu', kernel_initializer = 'lecun_uniform',  name = 'mlp_4')(deep_layer)
  deep_layer = tf.keras.layers.Dropout(dropout_rate_2, name = 'mlp_dropout_4')(deep_layer)
  deep_layer = tf.keras.layers.Dense(int(scale*100.), activation = 'relu', kernel_initializer = 'lecun_uniform',  name = 'mlp_7')(deep_layer)
